    ...
    <>
      ...
      <section className={`py-10 px-4 rounded-2xl max-w-4xl mx-auto my-8 shadow-lg border ${
        isDark 
          ...
          : "bg-yellow-50/80 border-yellow-400/30"
      }`}>
        <div className="text-center">
          <h2 className={`text-2xl md:text-3xl font-black mb-3`}>
            <span className={isDark ? "text-mg-gold" : "text-mg-charcoal"}>
              Trade with <span className="text-mg-green">MarketGod</span>
            </span>
            <span className="block text-mg-green">For <span className="underline decoration-mg-gold">FREE</span></span>
          </h2>

          <p className={`text-sm md:text-base mb-5 ${isDark ? "text-mg-paper/70" : "text-mg-charcoal/70"}`}>
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-mg-gold text-mg-charcoal font-bold text-sm md:text-base rounded-full shadow-md hover:shadow-mg-gold/50 transition-all"
          >
            <Zap size={18} />
